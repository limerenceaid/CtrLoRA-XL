...
class ControlNetLoraMulti(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    """
    A ControlNet model.
    ...
    def from_unet(
        ...
        if load_weights_from_unet:
            ...
            nn.init.zeros_(controlnet.conv_in_condition.weight)
            if controlnet.conv_in_condition.bias is not None:
                nn.init.zeros_(controlnet.conv_in_condition.bias)
    ...
    def forward(
        ...
        controlnet_cond = self.conv_in_condition(controlnet_cond)
