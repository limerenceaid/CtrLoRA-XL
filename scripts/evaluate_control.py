...
def get_parser():
    ...
    parser.add_argument("--detector", type=str, choices=[
        ...
        'lineart', 'lineart_anime', 'mlsd', 'palette', 'densepose', 'pixel'
    ], help='detector type')
    return parser
...
class SampleDataset(Dataset):
    def __init__(self, sample_dir: str):
        ...
        # test_image_save_path = f"/data/jingshirou/diffusers/examples/controlnet/gen_test_img/BASE-01/SDXL-Ctrlora/canny"
    ...
    def __getitem__(self, item):
        ...
        sample = resize_image(HWC3(sample), 512)
...
def main():
    ...
    with torch.no_grad():
        for sample, gt_control in tqdm.tqdm(dataloader):
